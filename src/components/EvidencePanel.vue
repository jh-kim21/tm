...
.kv-rows { display: flex; flex-direction: column; gap: 3px; }
.kv-row {
  display: flex;
...
.dist-label { font-size: 10px; font-weight: 700; color: #2c3345; }
.dist-bar-track {
  height: 8px;
  background: #eef1f7;
  border-radius: 3px;
...
.dist-count { font-size: 10px; color: #607090; text-align: right; white-space: nowrap; }
